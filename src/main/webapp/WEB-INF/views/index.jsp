                ...
                <form id="myForm">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            ...
                            <div class="input-label-absolute input-label-absolute-right">
                                ...
                                <input class="form-control pe-4" type="search" name="search" placeholder="키워드"
                                       id="form_search" value="${formDataVo.search}">
                            </div>
                        </div>
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="exhibition"
                                                       name="전시회">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 mb-4">
                                        ...
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="charged"
                                                           name="유료">
                        ...
                        <div class="col-6 mb-4">
                            <button id="submitBtn" class="btn btn-primary" type="submit"><i
                                    class="fas fa-filter me-1"></i>search
                            </button>
                        </div>
                            ...
                            <div class="card h-100 border-0 shadow">
                                <div class="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(resources/img/index/photo/restaurant-1430931071372-38127bd472b8.jpg); min-height: 200px;">
                                    ...
                                    <div class="card-img-overlay-bottom z-index-20">
                                        ...
                                        <h7 class="text-white text-shadow">${data.place}</h7>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <p class="text-sm text-muted mb-0">${data.roadAddress}</p>
                                    <p class="text-sm text-muted mb-0">${data.numberAddress}</p>
                                    <p class="text-sm text-muted mb-0">${data.category}</p>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
